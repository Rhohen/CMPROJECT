// $ANTLR 3.5.2 projet.g 2018-02-22 15:09:31
...
public class projetParser extends Parser {
	...
	public final void corps() throws RecognitionException {
		try {
			...
			// projet.g:87:10: 'debut' instructions 'fin'
			{
			PtGen.pt(3);
			match(input,30,FOLLOW_30_in_corps501); 
			pushFollow(FOLLOW_instructions_in_corps503);
			instructions();
			state._fsp--;

			match(input,40,FOLLOW_40_in_corps505); 
			PtGen.pt(200);
			}
	...
	public final void inssi() throws RecognitionException {
		try {
			...
			match(input,25,FOLLOW_25_in_inssi704); 
			...
			match(input,42,FOLLOW_42_in_inssi716); 
			}
	...
	public final void inscond() throws RecognitionException {
		try {
			...
			{
			match(input,28,FOLLOW_28_in_inscond730); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_inscond752); 
					pushFollow(FOLLOW_expression_in_inscond755);
					expression();
					state._fsp--;

					match(input,16,FOLLOW_16_in_inscond758); 
			...
			switch (alt31) {
				case 1 :
					...
					{
					match(input,26,FOLLOW_26_in_inscond777); 
			...
			match(input,39,FOLLOW_39_in_inscond798); 
			}
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			{
			match(input,53,FOLLOW_53_in_boucle813); 
			pushFollow(FOLLOW_expression_in_boucle816);
			expression();
			state._fsp--;

			match(input,36,FOLLOW_36_in_boucle818); 
			pushFollow(FOLLOW_instructions_in_boucle820);
			instructions();
			state._fsp--;

			match(input,37,FOLLOW_37_in_boucle822); 
			}
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_lecture835); 
			match(input,10,FOLLOW_10_in_lecture837); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_lecture844); 
					pushFollow(FOLLOW_ident_in_lecture846);
					ident();
					state._fsp--;
			...
			match(input,11,FOLLOW_11_in_lecture852); 
			}
	...
	public final void ecriture() throws RecognitionException {
		try {
			...
			{
			match(input,33,FOLLOW_33_in_ecriture865); 
			match(input,10,FOLLOW_10_in_ecriture867); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_ecriture874); 
			...
			match(input,11,FOLLOW_11_in_ecriture882); 
			}
	...
	public final void affouappel() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_affouappel898);
			ident();
			state._fsp--;
			...
			switch (alt36) {
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_affouappel906); 
					pushFollow(FOLLOW_expression_in_affouappel908);
					expression();
					state._fsp--;
				...
				case 2 :
					...
					switch (alt35) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_effixes_in_affouappel928);
							effixes();
							state._fsp--;
							...
							switch (alt34) {
								case 1 :
									...
									{
									pushFollow(FOLLOW_effmods_in_affouappel931);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effixes970); 
							pushFollow(FOLLOW_expression_in_effixes972);
							expression();
							state._fsp--;
			...
			match(input,11,FOLLOW_11_in_effixes980); 
			}
	...
	public final void effmods() throws RecognitionException {
		try {
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effmods999); 
							pushFollow(FOLLOW_ident_in_effmods1001);
							ident();
							state._fsp--;
			...
			match(input,11,FOLLOW_11_in_effmods1009); 
			}
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,47,FOLLOW_47_in_expression1027); 
					PtGen.pt(19);
					pushFollow(FOLLOW_exp1_in_expression1031);
					exp1();
					state._fsp--;
	...
	public final void exp1() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp2_in_exp11050);
			exp2();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,35,FOLLOW_35_in_exp11053); 
					PtGen.pt(19);
		...
		try {
			...
			switch (alt43) {
				case 1 :
					...
					{
					match(input,46,FOLLOW_46_in_exp21076); 
					pushFollow(FOLLOW_exp2_in_exp21078);
					exp2();
					state._fsp--;
				...
				case 2 :
					// projet.g:153:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21086);
					exp3();
					state._fsp--;
		...
		try {
			...
			switch (alt44) {
				case 1 :
					// projet.g:157:5: '=' exp4
					{
					match(input,22,FOLLOW_22_in_exp31109); 
					PtGen.pt(20);
				...
				case 2 :
					// projet.g:158:5: '<>' exp4
					{
					match(input,21,FOLLOW_21_in_exp31122); 
					PtGen.pt(20);
				...
				case 4 :
					// projet.g:160:5: '>=' exp4
					{
					match(input,24,FOLLOW_24_in_exp31147); 
					PtGen.pt(20);
				...
				case 5 :
					// projet.g:161:5: '<' exp4
					{
					match(input,19,FOLLOW_19_in_exp31159); 
					PtGen.pt(20);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_exp41210); 
					PtGen.pt(20);
					pushFollow(FOLLOW_exp5_in_exp41214);
					exp5();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,15,FOLLOW_15_in_exp41227); 
					PtGen.pt(20);
					pushFollow(FOLLOW_exp5_in_exp41231);
					exp5();
					state._fsp--;
	...
	public final void exp5() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_primaire_in_exp51258);
			primaire();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp51274); 
					PtGen.pt(20);
				...
				case 2 :
					...
					{
					match(input,32,FOLLOW_32_in_exp51295); 
					PtGen.pt(20);
					pushFollow(FOLLOW_primaire_in_exp51299);
					primaire();
					state._fsp--;
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1324);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire1332);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,10,FOLLOW_10_in_primaire1341); 
					pushFollow(FOLLOW_expression_in_primaire1343);
					expression();
					state._fsp--;

					match(input,11,FOLLOW_11_in_primaire1345); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_nbentier_in_valeur1359);
					nbentier();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,13,FOLLOW_13_in_valeur1367); 
					pushFollow(FOLLOW_nbentier_in_valeur1369);
					nbentier();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,15,FOLLOW_15_in_valeur1377); 
					pushFollow(FOLLOW_nbentier_in_valeur1379);
					nbentier();
					state._fsp--;
				...
				case 4 :
					// projet.g:186:5: 'vrai'
					{
					match(input,55,FOLLOW_55_in_valeur1387); 
					PtGen.pt(6);
					}
					break;
				case 5 :
					// projet.g:187:5: 'faux'
					{
					match(input,38,FOLLOW_38_in_valeur1395); 
					PtGen.pt(7);
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// projet.g:197:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1425); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// projet.g:199:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1436); 
	...
	public static final BitSet FOLLOW_30_in_corps501 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_corps503 = new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_40_in_corps505 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_25_in_inssi704 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inssi706 = new BitSet(new long[]{0x0010040000000000L});
	public static final BitSet FOLLOW_52_in_inssi709 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inssi712 = new BitSet(new long[]{0x0000040000000000L});
	public static final BitSet FOLLOW_42_in_inssi716 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_28_in_inscond730 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_inscond733 = new BitSet(new long[]{0x0000000000010000L});
	...
	public static final BitSet FOLLOW_14_in_inscond752 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_inscond755 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_16_in_inscond758 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inscond760 = new BitSet(new long[]{0x0000008004004000L});
	public static final BitSet FOLLOW_26_in_inscond777 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inscond780 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_39_in_inscond798 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_53_in_boucle813 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_boucle816 = new BitSet(new long[]{0x0000001000000000L});
	public static final BitSet FOLLOW_36_in_boucle818 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_boucle820 = new BitSet(new long[]{0x0000002000000000L});
	public static final BitSet FOLLOW_37_in_boucle822 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_43_in_lecture835 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_lecture837 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture839 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_lecture844 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture846 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_lecture852 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_33_in_ecriture865 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_ecriture867 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture869 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_ecriture874 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture876 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_ecriture882 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel898 = new BitSet(new long[]{0x0000000000020402L});
	public static final BitSet FOLLOW_17_in_affouappel906 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_affouappel908 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_effixes_in_affouappel928 = new BitSet(new long[]{0x0000000000000402L});
	public static final BitSet FOLLOW_effmods_in_affouappel931 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effixes963 = new BitSet(new long[]{0x008040400000AC60L});
	public static final BitSet FOLLOW_expression_in_effixes966 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effixes970 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_effixes972 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effixes980 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effmods992 = new BitSet(new long[]{0x0000000000000820L});
	public static final BitSet FOLLOW_ident_in_effmods995 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effmods999 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods1001 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_effmods1009 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp1_in_expression1023 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_47_in_expression1027 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp1_in_expression1031 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_exp2_in_exp11050 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_35_in_exp11053 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp11057 = new BitSet(new long[]{0x0000000800000002L});
	public static final BitSet FOLLOW_46_in_exp21076 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_exp2_in_exp21078 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp3_in_exp21086 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp31102 = new BitSet(new long[]{0x0000000001F80002L});
	public static final BitSet FOLLOW_22_in_exp31109 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31114 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_21_in_exp31122 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31126 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_exp31134 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31139 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_24_in_exp31147 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31151 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_19_in_exp31159 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp4_in_exp31164 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_exp31172 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_13_in_exp41210 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp5_in_exp41214 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_15_in_exp41227 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_exp5_in_exp41231 = new BitSet(new long[]{0x000000000000A002L});
	public static final BitSet FOLLOW_primaire_in_exp51258 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_12_in_exp51274 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51279 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_32_in_exp51295 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51299 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_valeur_in_primaire1324 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire1332 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_primaire1341 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_primaire1343 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_primaire1345 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1359 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_valeur1367 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1369 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_valeur1377 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1379 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_55_in_valeur1387 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_38_in_valeur1395 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1425 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1436 = new BitSet(new long[]{0x0000000000000002L});
}
